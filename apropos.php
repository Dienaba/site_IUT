...
<main class="container">
    ...
    <div class=mainAPropos>
        <p>Ce portail décrit les formations proposées dans les départements d'informatique des IUT, DUT et licence professionnelle.</p>

        <p>Les départements d'informatique des IUT de France forment des étudiants aux métiers de l'informatique en lien avec le domaine du développement de logiciels.
